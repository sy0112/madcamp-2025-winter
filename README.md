# 📱 AndroidLab (Madcamp 2025 Winter)

**AndroidLab**은 Madcamp 2025 Winter 시즌 동안 개발된 프로젝트 전시 및 관리 애플리케이션입니다. 사용자들이 자신의 프로젝트를 등록하고, 다른 이들의 프로젝트를 격자(Grid) 및 리스트(List) 형태로 둘러볼 수 있는 기능을 제공합니다.
